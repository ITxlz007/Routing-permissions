  ...
  <div>
    <div class="row h44">
      <form @submit.prevent="queryData" class="query">
        ...
        <input type="date" v-model="query.startDate" @change="query.quick_period=''" class="form-control"
          style="width:180px;margin-left: 10px" />
        <span>&nbsp;-&nbsp;</span>
        <input type="date" v-model="query.endDate" @change="query.quick_period=''" class="form-control"
          style="width:180px;" />
        <button-box type="search" @click="queryData"></button-box>
      </form>
    </div>

    <echarts ref="memberChart" :option="echarts.member.options" :url="echarts.member.url" :params="query"
      :parseData="echarts.member.parseData" width="100%" height="300"></echarts>
